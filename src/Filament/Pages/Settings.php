                ...
                ->schema([
                    ...
                    Tabs\Tab::make('Automation')
                        ...
                        ->schema([
                            ...
                            Select::make('automation.pastoral_coordinators_group')->label('Send pastoral co-ordinator emails to this group')
                                ->options(Group::all()->sortBy('groupname')->pluck('groupname', 'id'))
                                ->searchable(),
                            Select::make('automation.pastoral_coordinators_day')->label('Send pastoral co-ordinator emails on this day')
                                ->options([
                                    1 => 'Monday',
                                    2 => 'Tuesday',
                                    3 => 'Wednesday',
                            ...
                            Select::make('automation.tasks_day')->label('Send task reminders on this day')
                                ->options([
                                    1 => 'Monday',
                                    2 => 'Tuesday',
                                    3 => 'Wednesday',
