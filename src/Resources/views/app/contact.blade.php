    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-md-6 col-lg-6">
                <h3>Contact us</h3>
                <div>
                    <h4>WhatsApp us on <a target="_blank" title="WhatsApp" href="https://wa.me/27{{substr(setting('website.whatsapp'),1)}}">{{setting('website.whatsapp')}}</a></h4>
                    or
                    ...
                    <form method="post">
                        ...
                        <div class="input-group my-2">
                            <input name="user" type="email" class="form-control" placeholder="Your email address" required>&nbsp;
                            @honeypot
