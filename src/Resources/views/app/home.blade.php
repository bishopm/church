<x-church::website.applayout pageName="App home">
    ...
    @forelse ($content as $item)
        @if (isset($item->published_at))
            ...
            @if ($item->image)
                <div><img src="{{url('/storage/app/media/images/' . $item->image)}}" alt="Image" class="img-fluid rounded"></div>
            @endif
        ...
        @elseif (isset($item->readings))
            ...
            <a href="{{url('/')}}/sermons/{{date('Y',strtotime($item->series->startingdate))}}/{{$item->series->slug}}">
                <img class="card-img-top" src="{{url('/storage/app/media/images/' . $item->series->image)}}" alt="{{$item->series->series}}">
            </a>
        ...
        @elseif ($item->image)
            <a href="{{route('app.devotionals')}}">
                <img class="card-img-top" src="{{url('/storage/app/media/images/' . $item->image)}}" alt="{{$item->reading}}">
            </a>
        @endif
    @empty
