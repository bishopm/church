<x-church::website.layout pageName="Blog">
    ...
    @forelse ($posts as $post)
        <div class="mb-4 row">
            <div class="col-12">
                <div><a href="{{url('/blog') . '/' . date('Y',strtotime($post->published_at)) . '/' . date('m',strtotime($post->published_at)) . '/' . $post->slug}}"><img style="float:left; padding-right:10px;" width="200px" src="{{url('/storage/app/' . $post->image)}}" alt="Image" class="img-fluid rounded"></a></div>
