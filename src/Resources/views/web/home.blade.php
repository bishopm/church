                    ...
                    <div class="tab-pane fade" id="pills-audio" role="tabpanel" aria-labelledby="pills-audio-tab">
                        <div class="card">
                            <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                                <a href="{{url('/')}}/sermons/{{date('Y',strtotime($sermon->series->startingdate))}}/{{$sermon->series->slug}}"><img class="card-img-top" src="{{url('/storage/app/public/media/sermons/' . $sermon->series->image)}}"
            ...
            @foreach ($blogs as $blog)
                <div class="col-md-4 col-sm-12">
                    <div class="post-entry" data-aos="fade-up" data-aos-delay="100">
                        <a href="{{url('/blog') . '/' . date('Y',strtotime($blog->published_at)) . '/' . date('m',strtotime($blog->published_at)) . '/' . $blog->slug}}" class="thumb d-block"><img src="{{url('/storage/app/public/media/images/' . $blog->image)}}" alt="Image" class="img-fluid rounded"></a>
